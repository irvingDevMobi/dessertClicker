...
private fun DessertClickerApp(
    ...
    DessertScreen(dessertUiState = dessertUiState) { dessert ->
        viewModel.dessertSold(dessert.price)
    }
}
...
fun DessertScreen(
    ...
    val dessert = dessertUiState.currentDessert
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = { onDessertClicked(dessert) },
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        DessertScreen(
            dessertUiState = DessertUiState(Dessert(R.drawable.cupcake, 5, 0))
        )
    }
}
